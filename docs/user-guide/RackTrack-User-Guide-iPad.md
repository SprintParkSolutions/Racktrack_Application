# RackTrack User Guide — iPad edition

Point your phone at a rack. RackTrack maps every unit, device, switch and port — then checks it against your records.

*Screenshots taken on an iPad in landscape. Every screenshot was captured from the running application.*
...
![Create an organization](../screenshots/iPad/signup.png)
...
![Sign in](../screenshots/iPad/login.png)
...
![Reset a forgotten password](../screenshots/iPad/forgot-password.png)
...
A sidebar on the left carries **Home**, **Scan**, **Profile** and — for administrators — **Marketplace**.

> **IMPORTANT** — **On a big screen the camera has no shutter button** — the shutter is the phone's bottom **SCAN** tab, which does not exist here. Use **Upload** on an iPad or a computer.
...
![Find your way around](../screenshots/iPad/scan.png)
*The scan screen. The sidebar carries every screen.*
...
![Scan a rack](../screenshots/iPad/scan.png)
...
![Scan a rack too tall for one photo](../screenshots/iPad/scan-multi.png)
...
![Read the rack overview](../screenshots/iPad/results.png)
...
![Find a specific port](../screenshots/iPad/results.png)
...
![See what is plugged in right now](../screenshots/iPad/ports.png)
...
![See what is on the end of each cable](../screenshots/iPad/ports-cables.png)
...
![Check whether something is reachable](../screenshots/iPad/ports-trace.png)
...
![Check a switch's firmware and security](../screenshots/iPad/switch-firmware.png)
...
![Choose the right SFP module](../screenshots/iPad/switch-optics.png)
...
![See the rack as a diagram](../screenshots/iPad/topology.png)
...
![See what the network says about the rack](../screenshots/iPad/netdisco.png)
...
![Find out what changed, and when](../screenshots/iPad/drift-detail.png)
...
![Look up a datasheet](../screenshots/iPad/specs-result.png)
...
![Check any firmware version](../screenshots/iPad/firmware-result.png)
...
![Reopen a scan you did earlier](../screenshots/iPad/profile.png)
...
![Connect your CMDB](../screenshots/iPad/connections-add.png)
...
![Add people to your team](../screenshots/iPad/organizations.png)
...
![Sell surplus gear](../screenshots/iPad/marketplace-new.png)
*Creating a listing.*
