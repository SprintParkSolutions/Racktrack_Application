...
// ── Tiers ────────────────────────────────────────────────────────────
// Which audiences each tier may see. Unknown audiences fail closed.
const TIER_AUDIENCES = {
  'end-user': ['end-user'],
  admin: ['end-user', 'admin', 'internal-only'],
};

/** Map an authenticated user's role to a knowledge tier. Never trust the client. */
 ...
 */
async function ask(question, { tier = 'end-user', history = [] } = {}) {
