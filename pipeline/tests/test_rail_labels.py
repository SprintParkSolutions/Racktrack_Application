...
from pipeline.rail_labels import (
    is_plausible, read_rails, resolve_number_tails, vote, wide_enough,
)
...
OFFICE = [
    "SP-HyB-RMOI-ROL-RI", "SP-HyB AMOI-ROL-RI", "Sp-HyB-RMQI-Rof-AI",
    "SP HYD-AMOI-ROL-RI", "SP-HyB RMOI-ROL-RI", "Sp+hyd-AMOI-ROL-RI",
    "SP-HyB-RMOI-ROL-RI",
]
