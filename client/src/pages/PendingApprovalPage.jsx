...
const S = {
  ...
  badge: { display: 'inline-block', fontSize: 'var(--fs-label)', letterSpacing: '.2em', fontWeight: 'var(--fw-title)',
  ...
  blocked: { width: 46, height: 46, margin: '0 auto 20px', borderRadius: '50%',
    background: '#efefef', color: '#c0392b', fontSize: 26, fontWeight: 'var(--fw-title)',
    display: 'flex', alignItems: 'center', justifyContent: 'center' },
  h1: { margin: '0 0 10px', fontSize: 'var(--fs-page)', fontWeight: 'var(--fw-title)', color: '#232323' },
  p: { margin: '0 0 8px', color: '#545454', fontSize: 'var(--fs-section)', lineHeight: 1.6 },
  sub: { margin: '0 0 24px', color: '#929292', fontSize: 'var(--fs-body)' },
  primary: { width: '100%', padding: '13px', border: 0, borderRadius: 12, background: BLUE,
    color: '#fff', fontSize: 'var(--fs-section)', fontWeight: 'var(--fw-title)', cursor: 'pointer', marginBottom: 10 },
  ghost: { width: '100%', padding: '12px', border: '1px solid #dddddd', borderRadius: 12,
    background: '#fff', color: '#666666', fontSize: 'var(--fs-item)', fontWeight: 'var(--fw-label)', cursor: 'pointer' },
};
