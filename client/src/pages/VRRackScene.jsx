  ...
  return (
    <group>
      ...
      <mesh position={[0, -0.12, 0]}>
        ...
        <meshStandardMaterial color="#000000" metalness={0.6} roughness={0.55} />
      </mesh>
...
function DatacenterLights({ rackH }) {
  return (
    <>
      ...
      />
      {/* Rim light from rear */}
      <pointLight position={[0, rackH * 0.6, -6]} intensity={0.3} color="#4c4546" />
      {/* Accent from side */}
      <pointLight position={[6, rackH * 0.3, 0]} intensity={0.2} color="#000000" />
    </>
  );
}
